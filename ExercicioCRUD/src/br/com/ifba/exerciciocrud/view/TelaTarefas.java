...
public class TelaTarefas extends javax.swing.JFrame {
    ...
    private void txtPesquisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtPesquisaActionPerformed
        ...
        // Cria uma lista com os itens encontrados no banco de dados
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (linha == -1) {
            ...
            Query query = manager.createQuery("SELECT a FROM Tarefa a "
                + "WHERE a.nome LIKE ?1", Tarefa.class);
            query.setParameter(1, editar);
            
            // Gravando tarefa obtida pelo nome
            Tarefa trf = (Tarefa) query.getSingleResult();

            manager.close();
            factory.close();
            
            // Exibindo tela de edição de item, com os parâmetros da linha e tarefa.
            new TelaEditarTarefa(trf);
    ...
    public void atualizarTabela() {
        ...
        List<Tarefa> tar = manager.createQuery("SELECT a FROM Tarefa a", Tarefa.class).getResultList();
