...
public class TelaCriarTarefa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(spnQuantidade, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 124, -1, -1));
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        // Buscando se já existe tarefa de mesmo nome no banco de dados.
        Query query = manager.createQuery("SELECT a FROM Tarefa a "
                + "WHERE a.nome LIKE ?1", Tarefa.class);
        query.setParameter(1, tar.getNome());

        // Verifica se já existe tarefa de mesmo nome.
