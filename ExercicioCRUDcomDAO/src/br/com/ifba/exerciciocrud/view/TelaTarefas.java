...
public class TelaTarefas extends javax.swing.JFrame {
    ...
    private void txtPesquisaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtPesquisaActionPerformed
        ...
        List<Tarefa> resultado = trf.pesquisar(pesquisa);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (linha == -1) {
            ...
            List<Tarefa> tarefas = trf.pesquisar(editar);
            ...
            // Exibindo tela de edição de item, com o parâmetro da tarefa
    ...
    private void btnRemoverActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRemoverActionPerformed
        ...
        // Só dá continuidade à remoção se o usuário confirmar.
            ...
            List<Tarefa> resultado = trf.pesquisar(editar);
            
            // Apagando item encontrado do banco de dados
            trf.remover(resultado.get(0));
    ...
    public void atualizarTabela() {
        ...
        List<Tarefa> tar = trf.encontrarTodos();
